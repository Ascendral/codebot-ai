...
*Last updated 2026-04-25 (PR 7 refined in PR #31: idempotency declaration refactored from two competing optional fields into a single discriminated union — `idempotency?: { kind: 'arg', arg } | { kind: 'unsupported', reason }`; validator updated; test connector demonstrates both arms; §8 idempotency row rewritten). PR 7 landed in PR #30: connector contract foundation — fields on `ConnectorAction`, `ConnectorReauthError`, validator, test fixture, compliance baseline 0/50. Earlier passes: 2026-04-25 PR 6 (per-session budget cap + threshold audits); 2026-04-25 PR 5 (router rename + wire-up, same-provider only); 2026-04-25 PR 4 (capability-driven gating + move-money rejection); 2026-04-25 PR 3 (label population + CI enforcement); 2026-04-25 PR 2 (CapabilityLabel union + slot); 2026-04-25 split `move-money` from `spend-money`; 2026-04-24 engineering-contract discipline; 2026-04-24 user-owned multi-device-over-time vision. Against `main @ f63665d` + this PR.*
