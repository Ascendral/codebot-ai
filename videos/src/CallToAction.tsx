  ...
  return (
    <AbsoluteFill style={{ background: BG, justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ textAlign: 'center', transform: `scale(${scale})` }}>
        ...
        <FadeIn delay={40}>
          <div style={{ fontSize: 32, color: DIM, fontFamily: 'system-ui', marginTop: 30 }}>We can't do it alone.</div>
        </FadeIn>
      </div>
    </AbsoluteFill>
  );
  ...
  <AbsoluteFill style={{ background: BG, justifyContent: 'center', alignItems: 'center', padding: 100 }}>
    ...
    <div style={{ display: 'flex', gap: 30, flexWrap: 'wrap', justifyContent: 'center', maxWidth: 1400 }}>
      {[
        ...
        {
          name: 'KlomboAGI',
          desc: 'Experimental cognition runtime',
          stat: 'World model · Planner · Critic',
          color: GOLD,
        },
      ].map((item, i) => (
      ...
      {[
        {
          ...
          desc: 'Build tool chains, reasoning loops, and self-improvement systems',
          color: CYAN,
        },
        {
          role: 'Safety Researchers',
          desc: 'Help us prove CORD works — constitutional AI for autonomous agents',
          color: GREEN,
        },
        {
          role: 'ML Engineers',
          desc: 'Fine-tune models, optimize inference, push toward local-first AI',
          color: PURPLE,
        },
        ...
        <FadeIn key={i} delay={10 + i * 15}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 25 }}>
            ...
            <div>
              <span style={{ fontSize: 26, color: item.color, fontWeight: 700, fontFamily: 'system-ui' }}>
                {item.role}
              </span>
  ...
  return (
    <AbsoluteFill style={{ background: BG, justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ textAlign: 'center', transform: `scale(${scale})` }}>
        ...
        <FadeIn delay={15}>
          <div style={{ fontSize: 36, color: DIM, fontFamily: 'system-ui', marginTop: 15 }}>together.</div>
        </FadeIn>
        <FadeIn delay={35}>
          <div
            style={{
