...
const AgentScene: React.FC = () => (
  <AbsoluteFill style={{ background: BG, justifyContent: 'center', alignItems: 'center', padding: 100 }}>
    ...
    <FadeIn delay={10}>
      ...
      >
        Takes the task. Does the work.
        <br />
        <span style={{ color: CYAN }}>Checks its own work.</span>
        <br />
        Shows receipts.
      </div>
    </FadeIn>
  ...
  <AbsoluteFill style={{ background: BG, justifyContent: 'center', alignItems: 'center', padding: 100 }}>
    ...
    <FadeIn delay={10}>
      ...
      >
        ...
        <br />
        <span style={{ color: CYAN }}>CORD</span>{' '}
        <span style={{ color: DIM, fontSize: 32 }}>— Constitutional Safety</span>
      </div>
    </FadeIn>
    <FadeIn delay={35}>
      <div
      ...
      <div style={{ position: 'relative', width: 700, height: 500 }}>
        ...
        <FadeIn delay={50}>
          <div style={{ position: 'absolute', right: 80, top: 60, textAlign: 'center' }}>
            ...
            />
            <div style={{ fontSize: 22, color: CYAN, marginTop: 8, fontFamily: 'system-ui', fontWeight: 700 }}>
              CodeBot AI
            </div>
          </div>
        </FadeIn>
...
export const NotJustATool: React.FC = () => {
  return (
    <AbsoluteFill style={{ background: BG }}>
      ...
      <Sequence from={760} durationInFrames={180}>
        <SafetyScene />
      </Sequence>
      <Sequence from={940} durationInFrames={150}>
        <LocalScene />
      </Sequence>
      <Sequence from={1090} durationInFrames={180}>
        <GapScene />
      </Sequence>
      <Sequence from={1270} durationInFrames={530}>
        <CTAScene />
      </Sequence>
    </AbsoluteFill>
  );
