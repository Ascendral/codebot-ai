...
const StatBox: React.FC<{
  ...
  <FadeIn delay={delay}>
    <div style={{ textAlign: 'center', padding: '20px 40px' }}>
      <div style={{ fontSize: 72, fontWeight: 900, color, fontFamily: 'system-ui' }}>{value}</div>
      <div style={{ fontSize: 22, color: DIM, fontFamily: 'system-ui', marginTop: 8 }}>{label}</div>
    </div>
  </FadeIn>
);
  ...
  return (
    <AbsoluteFill style={{ background: BG, justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ textAlign: 'center', transform: `scale(${scale})` }}>
        <div style={{ fontSize: 80, fontWeight: 900, fontFamily: 'system-ui', color: WHITE }}>Behind the Build</div>
        <FadeIn delay={20}>
...
const ResultScene: React.FC = () => (
  <AbsoluteFill style={{ background: BG, justifyContent: 'center', alignItems: 'center', padding: 100 }}>
    ...
    <FadeIn delay={15}>
      ...
      >
        <div>
          <span style={{ color: CYAN }}>Issue:</span> #2 "Add --version flag to CLI"
        </div>
        <div>
          <span style={{ color: CYAN }}>Repo:</span> Ascendral/KlomboAGI
        </div>
        <div>
          <span style={{ color: CYAN }}>Files:</span> 2 changed (cli.py + test_cli.py)
        </div>
        <div>
          <span style={{ color: CYAN }}>Tests:</span> <span style={{ color: GREEN }}>PASSED</span>
        </div>
        <div>
          <span style={{ color: CYAN }}>Review:</span> <span style={{ color: GREEN }}>APPROVE</span>
        </div>
        <div>
          <span style={{ color: CYAN }}>Cost:</span> $0.21
        </div>
        <div>
          <span style={{ color: CYAN }}>Time:</span> 90 seconds
        </div>
        <div style={{ marginTop: 10 }}>
          <span style={{ color: CYAN }}>PR:</span>{' '}
          <span style={{ color: GREEN }}>github.com/Ascendral/KlomboAGI/pull/4</span>
        </div>
      </div>
    </FadeIn>
    <FadeIn delay={50}>
